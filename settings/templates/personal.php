...
<div class="section">
	...
	<strong><?php p($theme->getName()); ?></strong> <!--?php p(OC_Util::getHumanVersion()) ?--><?php echo "Beta 1.0"; ?>

<br />
<?php if (OC_Util::getEditionString() === ''): ?>
	<!--?php print_unescaped($l->t('Developed by the ownCloud community, the <a href="https://github.com/skyboxone" target="_blank">source code</a> is licensed under the <a href="http://www.gnu.org/licenses/agpl-3.0.html" target="_blank"><abbr title="Affero General Public License">AGPL</abbr></a>.')); ?-->
<?php endif; ?>
</div>
