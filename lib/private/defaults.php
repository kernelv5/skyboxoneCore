...
class OC_Defaults {
	...
	function __construct() {
		...
		$this->defaultEntity = 'Skyboxone'; /* e.g. company name, used for footers and copyright notices */
		$this->defaultName = 'Skyboxone'; /* short name, used when referring to the software */
		$this->defaultTitle = 'Skyboxone'; /* can be a longer name, for titles */
		$this->defaultBaseUrl = 'https://www.skyboxone.com';
		...
		$this->defaultSlogan = $this->l->t('Your Data. Your Control.');
